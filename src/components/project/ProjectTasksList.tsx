...
import { Plus, Check, X, Trash2, Flag, Pencil } from 'lucide-react'
...
function TaskItem({
  ...
  return (
    <div className={`bg-white border rounded-lg p-4 ${task.is_completed ? 'opacity-75' : ''
      ...
      <div className="flex items-center space-x-3">
        <button
          ...
          disabled={isUpdating}
          className={`w-6 h-6 rounded border-2 flex items-center justify-center transition-colors ${task.is_completed
        ...
        <div className="flex-1">
          <p className={`text-sm ${task.is_completed
