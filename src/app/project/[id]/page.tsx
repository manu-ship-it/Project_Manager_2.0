...
export default function ProjectDetailsPage() {
  ...
  const [activeTab, setActiveTab] = useState<'overview' | 'joinery' | 'tasks' | 'materials' | 'installer'>('overview')
          ...
          <div className="flex items-center justify-between py-6">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-600">#{project.project_number} • {project.client}</p>
              </div>
            </div>
            <div className="flex items-center space-x-4">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white rounded-lg shadow-sm border mt-6">
          ...
          <div className="p-6">
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                  ...
                  <div className="bg-gray-50 rounded-lg p-4">
                    ...
                    <span className={`inline-flex px-2 py-1 text-xs font-medium rounded-full ${getStatusColor(project.project_status)}`}>
                    ...
                    <div className="space-y-3">
                      ...
                      {project.project_address && (
                        <div>
                          ...
                          <p className="text-gray-900">{project.project_address}</p>
                        </div>
                      )}
                    </div>
                  </div>
                  ...
                  <div className="bg-white border rounded-lg p-6">
                    ...
                    <div className="space-y-3">
                      <div>
                        ...
                        <p className="text-gray-900">{format(new Date(project.date_created), 'MMM dd, yyyy')}</p>
                      </div>
                      {project.install_commencement_date && (
                        <div>
            ...
            {activeTab === 'materials' && <MaterialsList projectId={projectId} />}
